...
import { Tractor, User, Mail, Lock, Loader2, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center p-4">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          <div className="bg-krishi-saffron p-4 rounded-2xl mb-4 shadow-lg shadow-krishi-saffron/20 text-slate-900">
            <Tractor className="w-8 h-8" />
          </div>
          <h1 className="text-3xl font-serif font-black text-slate-900">Create Account</h1>
          <p className="text-slate-500 mt-2">Join the Krishi Rental community</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          <div className="space-y-2">
            <label className="text-xs uppercase font-black text-slate-400 tracking-widest pl-1">Full Name</label>
